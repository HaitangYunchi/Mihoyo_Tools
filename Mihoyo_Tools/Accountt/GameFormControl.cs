...
namespace Mihoyo_Tools
{
    public class GameFormControl
    {
        ...
        private Control_Account formMain;
        ...
        public void InitControl(Control_Account formMain, TabPage tabPage, string pathSetting)
        {
...
崩坏3：\Honkai Impact 3rd\Game\BH3.exe";
        ...
        internal void InitControl(Control_Account control_Account, XtraTabPage tabPageGenshin, string genshinPath)
        {
